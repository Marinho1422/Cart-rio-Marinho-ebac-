...
#include <locale.h> //Biblioteca de alocaçôes de tecto por região
...
int registro()
{
	...
	strcpy(arquivo, cpf); //Responsável por copiar os dados do cpf para o arquivos
